 ...
 * @author Windows
 */
@WebServlet(name = "ToggleStatus", urlPatterns = {"/ToggleStatus"})
public class ToggleStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int result = new AccountDAO().updateIsUsed(account, !isUse);
        if (result != 0)
...
//        request.getRequestDispatcher("ListAccount.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        processRequest(request, response);
//        String account = request.getParameter("account");
//        int result = new AccountDAO().updateIsUsed(account);
//        if (result != 0)
